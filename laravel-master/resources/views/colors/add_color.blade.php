...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="cmxform edit-profile-form form-horizontal form-label-left" id="addColorForm" method="POST" action="{{ route('colors.store') }}" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>name</label>
                                <input id="name" class="form-control  @error('name') is-invalid @enderror" name="name" type="text" value="{{ old('name') }}"   placeholder="Name" >
                                @error('name')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Hexcode</label> 
                                <input id="hexcode color3" class="form-control colorpicker  @error('hexcode') is-invalid @enderror" name="hexcode" type="text" value="{{ old('hexcode') }}"   placeholder="Hexcode" >
                                @error('hexcode')
                                    <span class="invalid-feedback has-error" role="alert">
                                    <strong class="help-block">{{ $message }}</strong>
                                    </span>

<header class="main-header">
    ...
    <a href="{{ route('home') }}" class="logo">
        <img class="logo-lg logo-line" src="{{ asset('assets\dist\img\inner-line-logo-golden.png') }}" alt="logo" height="20">
        <img class="logo-mini" src="{{ asset('assets\dist\img\mini.png') }}" alt="logo" height="30">
    </a>
